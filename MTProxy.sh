...
ssh -o StrictHostKeyChecking=no $admin_username@$mtproxy_public_ip "sudo systemctl daemon-reload && sudo systemctl enable MTProxy.service && sudo systemctl restart MTProxy.service && sudo systemctl status MTProxy.service"
